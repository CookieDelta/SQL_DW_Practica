-- FORMATO DE FECHA (PARA START DATE)
/*SELECT start_date
     , FORMAT_DATE('%d-%m-%y', start_date)    
...
LEFT JOIN `keepcoding.ivr_modules` AS ivr_modules --la misma llamada puede tener varios registros al pasar por distintos modules
